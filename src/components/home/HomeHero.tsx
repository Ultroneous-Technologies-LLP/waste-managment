...
const HomeHero: FC<HomeHeroProps> = ({ data }) => {
  return (
    <Container className="pt-21 md:pt-32 xl:pt-34 px-4 md:px-6 xl:px-12.5 pb-20 xl:pb-30 grid grid-cols-1 xl:grid-cols-2 gap-6">
      <div className="p-6 md:p-14 bg-primary-yellow rounded-3xl xl:rounded-[56px]">
        <Title title={data.title} className="min-w-77.5 xl:max-w-100 w-full" />
        ...
        <div className="mt-11 md:mt-17.5 xl:mt-11 flex gap-2">
          <ArrowWithBackGround />
          <ArrowWithBackGround svgClassName="rotate-180" className="" />
        </div>
      </div>
      <div>
        <Image
